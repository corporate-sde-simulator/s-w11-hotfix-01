...
> **Welcome to Service-Track Week 11, Hotfix 1!**
...
1. **Read the comments** at the top of `cors_fix.js` - they describe the problem
...
| File | Purpose |
|------|---------|
| `cors_fix.js` | The code with bugs - **fix this file** |
...
### Bug #2
**User Report / Alert:**
> "Allows ALL origins — should check against whitelist"
...
1. **Read the top comment block** in `cors_fix.js` carefully - it has:
